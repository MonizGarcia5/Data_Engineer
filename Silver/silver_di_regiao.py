...
# Objetivo : Criar a tabela di_regiao na Base de dados Silver (Databricks)
...
df = spark.sql(" select codigo_regiao,descricao_regiao,nome_pais from {}.{}".format(data_base_bronze,table)) 
